# -*- coding: utf-8 -*-
"""Complex Model building to interpretability(LIME).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kIKltxoT4si2JDuhaE6ZvkGi8_38rnhP
...
# Imputer is deprecated, use SimpleImputer instead
from sklearn.impute import SimpleImputer
from sklearn.preprocessing import MinMaxScaler
from sklearn.preprocessing import LabelEncoder
from sklearn.metrics import accuracy_score
# cross_validation is deprecated, use model_selection instead
...
# prompt: load train and test from files from drive

from google.colab import drive
drive.mount('/content/drive')

train_df = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/train_LIME.csv')  # Replace with your actual file path
test_df = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/test_LIME.csv')   # Replace with your actual file path
...
validation_size = 0.2
seed = 7
# Use train_test_split directly from sklearn.model_selection
...
# Create a lambda function for each classifier that will return the
# predicted probability for the target variable (surge pricing type) given the set of features
...
exp = explainer.explain_instance(X_validation[observation_1], predict_fn_logreg, num_features=3)
exp.show_in_notebook(show_all=False)

# Get the explanation for RandomForest
exp = explainer.explain_instance(X_validation[observation_1], predict_fn_rf, num_features=3)
exp.show_in_notebook(show_all=False)

# Get the explanation for XGBoost
exp = explainer.explain_instance(X_validation[observation_1], predict_fn_xgb, num_features=3)
exp.show_in_notebook(show_all=False)
